...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen pt-24 pb-20 overflow-hidden bg-gradient-hero">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="flex flex-col items-center text-center mb-12 md:mb-16">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 animate-fade-in delay-100">
        ...
        <div ref={chartRef} className="relative glass rounded-2xl shadow-glass p-6 max-w-4xl mx-auto opacity-0 animate-on-scroll">
          <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 inline-flex items-center px-4 py-2 rounded-full bg-white shadow-md text-sm font-medium text-foreground">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="rounded-lg bg-white p-4 shadow-sm">
              ...
              <div className="text-xl font-semibold">4,183.95</div>
            ...
            <div className="rounded-lg bg-white p-4 shadow-sm">
              <div className="text-sm text-muted-foreground mb-1">NASDAQ</div>
              <div className="text-xl font-semibold">13,591.75</div>
              <div className="flex items-center text-sm stock-positive">
                <TrendingUp className="h-3 w-3 mr-1" />
                <span>+1.56%</span>
              </div>
            ...
            <div className="rounded-lg bg-white p-4 shadow-sm">
              <div className="text-sm text-muted-foreground mb-1">Dow Jones</div>
              <div className="text-xl font-semibold">34,372.34</div>
          ...
          <div className="rounded-lg bg-white p-4 shadow-sm h-64 flex items-center justify-center">
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="card-hover rounded-xl bg-gradient-card p-6 shadow-sm opacity-0 animate-on-scroll">
            <div className="rounded-full bg-primary/10 w-12 h-12 flex items-center justify-center mb-4">
              <BarChart3 className="h-6 w-6 text-primary" />
            </div>
            <h3 className="text-lg font-semibold mb-2">Technical Analysis</h3>
            <p className="text-muted-foreground">Advanced charting and technical indicators to identify trends and trading opportunities.</p>
          </div>
          
          <div className="card-hover rounded-xl bg-gradient-card p-6 shadow-sm opacity-0 animate-on-scroll delay-100">
            <div className="rounded-full bg-primary/10 w-12 h-12 flex items-center justify-center mb-4">
              <PieChart className="h-6 w-6 text-primary" />
            </div>
            <h3 className="text-lg font-semibold mb-2">Fundamental Analysis</h3>
            <p className="text-muted-foreground">Comprehensive financial data and ratios to evaluate company performance and value.</p>
          </div>
          
          <div className="card-hover rounded-xl bg-gradient-card p-6 shadow-sm opacity-0 animate-on-scroll delay-200">
            <div className="rounded-full bg-primary/10 w-12 h-12 flex items-center justify-center mb-4">
              <TrendingUp className="h-6 w-6 text-primary" />
            </div>
            <h3 className="text-lg font-semibold mb-2">Market Insights</h3>
            <p className="text-muted-foreground">Real-time market data and curated watchlists to keep track of the stocks that matter to you.</p>
          </div>
        </div>
      </div>
